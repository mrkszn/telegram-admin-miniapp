...
export const uk = {
  ...
  'clients.profile.backToProfile': 'Назад до профілю',
  'clients.profile.sessionsTitle': 'Сесії клієнта',
  'clients.profile.noSessions': 'Немає сесій для цього клієнта.',
...
export const en: Record<TranslationKey, TranslationEntry> = {
  ...
  'clients.profile.backToProfile': 'Back to profile',
  'clients.profile.sessionsTitle': 'Client sessions',
  'clients.profile.noSessions': 'No sessions for this client.',
